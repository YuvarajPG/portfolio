const CardSection = ({
    ...
    return (
        <div className={`flex  gap-2 ${className} h-auto w-fit text-center`}>
            {link ? (
                <a href={link} className="text-blue-500 hover:underline mt-2">
                    <div className="bg-white dark:bg-gray-700 pt-4 pb-2 rounded-lg shadow-sm border-1.5 border-black hover:in-hover:shadow-2xl shadow-cyan-950  transition-all duration-300 w-25">
