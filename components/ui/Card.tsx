    ...
    const cardVariants = {
        ...
        return (
            ...
            >
                {/* Text content */}
                <div className="z-10">
                    <h3 className="mb-2 text-3xl font-medium tracking-tight text-card-foreground">
                        {title}
                    </h3>
                ...
                <div className="absolute bottom-0 right-0 h-40 w-40 -translate-x-1/5 translate y-1/4 transform">
                    <motion.img
                        src={imageUrl}
