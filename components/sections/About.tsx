    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-5 w-full">
          <div
            ref={cardRef}
            className="group relative w-full border border-theme bg-theme-surface overflow-hidden p-3 transition-colors duration-300 opacity-0 rounded-2xl shadow-xl"
          >
            {/* Top Bar Header */}
            ...
            <div className="relative aspect-3/4 w-full overflow-hidden my-3 border border-theme/40 bg-theme/50 rounded-xl">
              ...
              <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between text-white font-mono text-xs z-10 transform translate-y-1 group-hover:translate-y-0 transition-transform duration-300">
                ...
                <span className="bg-black/70 backdrop-blur-md p-1.5 border border-white/10 group-hover:bg-white group-hover:text-black transition-colors duration-300 rounded-lg">
