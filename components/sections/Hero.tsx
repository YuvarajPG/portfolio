            ...
            >
                ...
                >
                    ...
                    <a
                        ...
                        className="py-1.5 rounded-full font-medium transition-all hover:scale-105 z-99 text-white bg-orange-700 px-4 mt-5 animate-in fade-in duration-150 ease-in block text-center hover:cursor-pointer hover:bg-orange-600 animate-in fade-in duration-3000 ease-in"
                    >
                        Download CV
                    </a>
                </motion.div>
